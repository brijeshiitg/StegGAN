...
class Steganalyzer(nn.Module):
	...
	def forward(self, x): # x is input
		...
		x = self.avgpool1(torch.tanh(self.bn1(torch.abs(self.conv1(x)))))
		# print('group1: ', x.size())
		x = self.avgpool2(torch.tanh(self.bn2(self.conv2(x))))
		# print('group2: ', x.size())
		x = self.avgpool3(self.relu3(self.bn3(self.conv3(x))))
		# print('group3: ', x.size())
		x = self.avgpool4(self.relu4(self.bn4(self.conv4(x))))
		# print('group4: ', x)
		x = self.avgpool5(self.relu5(self.bn5(self.conv5(x))))
		# print('group5: ', x.size())
